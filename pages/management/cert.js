...
initLayout({ pageId: 'cert-dashboard', breadcrumbs: ['정회원 관리', '인증 현황'] });
...
content.innerHTML = `
  <div style="display:flex;align-items:center;justify-content:center;min-height:60vh;flex-direction:column;gap:20px;">
    ...
    <p style="color:var(--text-muted);font-size:14px;text-align:center;line-height:1.6;max-width:400px;">
      인증 현황 페이지는 현재 개발 진행 중입니다.<br>
      빠른 시일 내에 서비스를 제공할 예정입니다.
    </p>
    <div style="display:flex;gap:12px;margin-top:8px;">
      <span class="badge badge--blue" style="font-size:12px;padding:6px 16px;">예정 기능: 서류인증 통합 현황</span>
      <span class="badge badge--green" style="font-size:12px;padding:6px 16px;">인증 진행률 대시보드</span>
    </div>
  </div>
`;
