...
const BRANCHES_FULL = [
  {code:'1',name:'퍼플스본사'},{code:'2',name:'퍼플스부산'},{code:'3',name:'퍼플스대전'},
  {code:'4',name:'퍼플스대구'},{code:'5',name:'퍼플스광주'},{code:'8',name:'퍼플스경기'},
  {code:'6',name:'디노블본사'},{code:'7',name:'디노블부산'},{code:'9',name:'르매리'}
];
