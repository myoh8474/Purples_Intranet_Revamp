...
const BRANCHES = ['퍼플스본사','퍼플스부산','퍼플스대전','디노블본사','디노블부산','르매리'];

// ── 더미 데이터 ──
const DUMMY = [
  { id: 'M001', name: '이상훈', gender: '남', age: 38, brand: '퍼플스', branch: '퍼플스본사', program: '다이아몬드 A', status: '소송중', marriageConfirm: '소송중', memberId: '1m00901', matchingManager: '김태희', consultantManager: '이지연', meetingCount: 8, contractType: '횟수제', contractCount: 12, joinDate: '2025-03-15', region: '서울', phone: '010-9999-0001', paymentStatus: '소송진행', marriageFee: 10000000, history:[{date:'2025-10-01',from:'확인전',to:'확인중',by:'김태희'},{date:'2025-12-15',from:'확인중',to:'성혼비 없음',by:'법무팀'},{date:'2026-02-10',from:'성혼비 없음',to:'소송중',by:'법무팀'}], legalMemos:[{date:'2026-02-10',type:'법무',writer:'법무팀 김법무',content:'성혼비 납부 거부, 소송 절차 착수'},{date:'2026-03-05',type:'성혼비',writer:'법무팀 김법무',content:'1차 내용증명 발송 완료'},{date:'2026-04-15',type:'법무',writer:'법무팀 김법무',content:'민사소송 접수 (서울중앙지법)'}], callLogs:[{date:'2026-01-20',time:'14:30',callType:'납부안내',result:'통화완료',caller:'법무팀 김법무',content:'성혼비 1,000만원 납부 안내, 회원 납부 거부 의사 표명'},{date:'2026-02-05',time:'10:15',callType:'법적안내',result:'통화완료',caller:'법무팀 김법무',content:'내용증명 발송 예정 안내, 최종 납부 기한 2월 28일까지 안내'},{date:'2026-03-15',time:'16:00',callType:'법적안내',result:'부재중',caller:'법무팀 김법무',content:'소송 접수 안내 시도, 부재중 — 문자 발송'}] },
  { id: 'M002', name: '박소영', gender: '여', age: 34, brand: '퍼플스', branch: '퍼플스본사', program: '플래티늄(루비) A', status: '소송중', marriageConfirm: '소송중', memberId: '1f00902', matchingManager: '이수현', consultantManager: '김민희', meetingCount: 5, contractType: '횟수제', contractCount: 8, joinDate: '2025-06-20', region: '경기', phone: '010-9999-0002', paymentStatus: '소송진행', marriageFee: 8000000, history:[{date:'2026-01-10',from:'확인전',to:'확인중',by:'이수현'},{date:'2026-03-20',from:'확인중',to:'소송중',by:'법무팀'}], legalMemos:[{date:'2026-03-20',type:'법무',writer:'법무팀 이법무',content:'혼인신고 확인, 성혼비 납부 안내 통화'},{date:'2026-04-01',type:'성혼비',writer:'법무팀 이법무',content:'납부 거부 의사 확인, 소송 진행 결정'}] },
  { id: 'M003', name: '김민수', gender: '남', age: 41, brand: '디노블', branch: '디노블본사', program: '시크릿 A', status: '성혼', marriageConfirm: '성혼', memberId: '7m00903', matchingManager: '박지영', consultantManager: '박수정', meetingCount: 10, contractType: '횟수제', contractCount: 10, joinDate: '2024-11-05', region: '서울', phone: '010-9999-0003', paymentStatus: '납부완료', marriageFee: 15000000, history:[{date:'2025-06-01',from:'확인전',to:'미팅중',by:'박지영'},{date:'2025-09-10',from:'미팅중',to:'확인중',by:'박지영'},{date:'2025-11-20',from:'확인중',to:'성혼',by:'회장님 승인'}], legalMemos:[{date:'2025-11-15',type:'성혼비',writer:'법무팀 김법무',content:'성혼비 1,500만원 납부 완료 확인'},{date:'2025-11-20',type:'법무',writer:'법무팀 김법무',content:'회장님 승인 완료, 최종 성혼 확정'}], callLogs:[{date:'2025-10-20',time:'09:30',callType:'납부안내',result:'통화완료',caller:'법무팀 김법무',content:'성혼비 1,500만원 납부 안내, 회원 납부 동의'},{date:'2025-11-10',time:'14:00',callType:'지급요청',result:'통화완료',caller:'법무팀 김법무',content:'납부 계좌 안내 및 입금 확인 요청'}] },
  { id: 'M004', name: '최서연', gender: '여', age: 32, brand: '퍼플스', branch: '퍼플스부산', program: '골드(사파이어) A', status: '결혼예정', marriageConfirm: '확인중', memberId: '2f00904', matchingManager: '최은별', consultantManager: '최영미', meetingCount: 6, contractType: '횟수제', contractCount: 8, joinDate: '2025-01-10', region: '부산', phone: '010-9999-0004', paymentStatus: '미정', marriageFee: 5000000 },
  { id: 'M005', name: '정태호', gender: '남', age: 36, brand: '퍼플스', branch: '퍼플스경기', program: '플래티늄(루비) B', status: '교제', marriageConfirm: '성혼비 없음', memberId: '6m00905', matchingManager: '서다현', consultantManager: '한소영', meetingCount: 7, contractType: '기간제', contractCount: 12, joinDate: '2025-04-22', region: '경기', phone: '010-9999-0005', paymentStatus: '미납', marriageFee: 8000000 },
  { id: 'M006', name: '한채원', gender: '여', age: 29, brand: '르매리', branch: '르매리', program: '골드(사파이어) B', status: '성혼', marriageConfirm: '성혼', memberId: '9f00906', matchingManager: '정유리', consultantManager: '정다은', meetingCount: 9, contractType: '횟수제', contractCount: 10, joinDate: '2024-09-18', region: '서울', phone: '010-9999-0006', paymentStatus: '납부완료', marriageFee: 5000000 },
  { id: 'M007', name: '오진우', gender: '남', age: 43, brand: '퍼플스', branch: '퍼플스본사', program: '블랙클럽 A', status: '만료', marriageConfirm: '만기', memberId: '1m00907', matchingManager: '김태희', consultantManager: '서윤아', meetingCount: 12, contractType: '횟수제', contractCount: 12, joinDate: '2024-05-10', region: '서울', phone: '010-9999-0007', paymentStatus: '미정', marriageFee: 20000000 },
  { id: 'M008', name: '송하림', gender: '여', age: 31, brand: '퍼플스', branch: '퍼플스대전', program: '실버(에메랄드) A', status: '외부교제', marriageConfirm: '외부결혼', memberId: '3f00908', matchingManager: '강보라', consultantManager: '강미래', meetingCount: 3, contractType: '횟수제', contractCount: 6, joinDate: '2025-08-01', region: '대전', phone: '010-9999-0008', paymentStatus: '미정', marriageFee: 3000000 },
  { id: 'M009', name: '배준서', gender: '남', age: 37, brand: '디노블', branch: '디노블부산', program: '다이아몬드 B', status: '활동', marriageConfirm: '위임서류 미비', memberId: '8m00909', matchingManager: '한서진', consultantManager: '윤하나', meetingCount: 4, contractType: '기간제', contractCount: 18, joinDate: '2025-07-15', region: '부산', phone: '010-9999-0009', paymentStatus: '미정', marriageFee: 10000000 },
  { id: 'M010', name: '류지안', gender: '여', age: 35, brand: '퍼플스', branch: '퍼플스본사', program: '플래티늄(루비) A', status: '활동', marriageConfirm: '미팅중', memberId: '1f00910', matchingManager: '이수현', consultantManager: '오세은', meetingCount: 5, contractType: '횟수제', contractCount: 8, joinDate: '2025-09-01', region: '서울', phone: '010-9999-0010', paymentStatus: '미정', marriageFee: 8000000 },
  { id: 'M011', name: '남동현', gender: '남', age: 40, brand: '퍼플스', branch: '퍼플스본사', program: '시크릿 B', status: '활동', marriageConfirm: '확인전', memberId: '1m00911', matchingManager: '김태희', consultantManager: '이지연', meetingCount: 2, contractType: '횟수제', contractCount: 10, joinDate: '2026-01-05', region: '서울', phone: '010-9999-0011', paymentStatus: '미정', marriageFee: 15000000 },
  { id: 'M012', name: '임서진', gender: '여', age: 33, brand: '디노블', branch: '디노블본사', program: '골드(사파이어) A', status: '성혼', marriageConfirm: '중복', memberId: '7f00912', matchingManager: '박지영', consultantManager: '김민희', meetingCount: 7, contractType: '횟수제', contractCount: 8, joinDate: '2024-12-20', region: '경기', phone: '010-9999-0012', paymentStatus: '확인필요', marriageFee: 5000000 },
];
